...
import { StyleSheet, Dimensions, View, Text, Image, TextInput, TouchableOpacity, BackHandler } from 'react-native';
import Icon from 'react-native-vector-icons/FontAwesome5';

class FundTransferScreen extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			accountNumber: '',
	...
	submitTransfer = () => {
		// console.log(this.state.amount);
			...
			this.state.accountNumber === ''){
				...
				this.setState({amount:this.formatBeforeSubmit(this.state.amount)},()=>{
					console.log(this.state.amount)
					this.props.navigation.navigate('Transfer1',{  
